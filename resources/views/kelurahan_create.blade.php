                    ...
                    <div class="card-body">
                        <form action="{{ route('provinsi.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="T_PROVINSI">
                                    @foreach($prov as $row)
                                    <option value="{{$row->id}}">{{$row->kode}} - {{$row->name}}</option>
                                    @endforeach
                                </select>
                                <input type="text" class="form-control @error('T_PROVINSI') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Masukkan nama">
